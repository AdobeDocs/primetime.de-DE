...
Programmierer P verfügt über eine iPhone-Anwendung, eine iPad-Anwendung und eine Website. Sie muss in die Adobe Concurency Monitoring (CM) integriert werden, um die Anzahl der gleichzeitigen Streams zwischen diesen Apps zu begrenzen. Der Programmierer erstellt Richtlinien, die die gleichzeitige Nutzung einschränken. Wir werden uns zwei Beispiele ansehen:
