...
| --- | --- | --- | --- |
| Endpunkt | Endpunkt für die Überwachung der Adobe-Parallelität | http://streams.adobeprimetime.com/v1/ | http://streams.adobeprimetime.com/v1/ |
...
| Intervall für Heartbeats | Intervall in Sekunden zum Senden von Heartbeat-Aufrufen an Adobe Concurrency Monitoring | 60 | 60 |
| Intervall für Stream-Compliance | Intervall in Sekunden zur Überprüfung der Stream-Konformität mit der Adobe Concurrency Monitoring | 180 | 180 |
