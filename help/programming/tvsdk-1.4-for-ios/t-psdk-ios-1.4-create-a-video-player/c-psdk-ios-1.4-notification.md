---
description: Der Player kann auf eine Reihe von Ereignissen warten, die den Status des Players angeben.
...
Der Player kann auf eine Reihe von Ereignissen warten, die den Status des Players angeben.

Angenommen, `PTMediaPlayer` ist eine Eigenschaft des Client-Players, `self.player` im folgenden Beispiel steht für die `PTMediaPlayer` -Instanz. Im folgenden Beispiel wird die `addObservers` -Methode, die in den PTMediaPlayer-Einrichtungsanweisungen angezeigt wird und die meisten Benachrichtigungen enthält:
...
`ThePTMediaPlayerNotifications` -Klasse listet die Benachrichtigungen auf, die das TVSDK an Ihren Player sendet.
...
<table frame="all" colsep="1" rowsep="1" id="table_ios_notifications"> 
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Eine Anzeige wurde fortgeführt. Wird während der Wiedergabe einer Anzeige ständig gesendet. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Die Pufferung wurde abgeschlossen. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> <span class="codeph"> PTMediaPlayerBufferingStartedNotification </span> </td> 
   <td colname="2"> Der Medienplayer wechselt in den Pufferstatus. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> <span class="codeph"> PTAudioTrackChangeCompleted </span> </td> 
   <td colname="2"> Eine Änderung am Audio-Track des derzeit wiedergegebenen Mediums ist abgeschlossen. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> <span class="codeph"> PTAudioTrackChangeStarted </span> </td> 
   <td colname="2"> Eine Änderung am Audio-Track des derzeit wiedergegebenen Mediums wird eingeleitet. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> <span class="codeph"> PTMediaPlayerItemChangedNotification </span> </td> 
   <td colname="2"> eine andere <span class="codeph"> PTMediaPlayerItem </span> des <span class="codeph"> PTMediaPlayer </span> wurde festgelegt. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Eine neue <span class="codeph"> PTNotification </span> wurde zum <span class="codeph"> PTNotificationHistoryItem </span> des aktuellen <span class="codeph"> PTMediaPlayerItem </span>, also wenn ein Benachrichtigungsereignis zum Benachrichtigungsverlauf hinzugefügt wird. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Der Player-Status hat sich geändert. Mögliche Statuswerte sind: 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Die aktuelle Wiedergabezeit hat sich geändert. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> <span class="codeph"> PTMediaPlayerTimelineChangedNotification </span> </td> 
   <td colname="2"> Die aktuelle Player-Timeline wurde geändert. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1" colsep="1" rowsep="1"> <span class="codeph"> PTTimedMetadataChangedNotification </span> </td> 
   <td colname="2"> Das TVSDK entdeckte das erste Vorkommen eines abonnierten Tags. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"> <span class="codeph"> PTTimedMetadataChangedInBackgroundNotification </span> </td> 
   <td colname="2"> <p>Ein abonniertes Tag wird auf dem Hintergrundmanifest identifiziert und ein neuer <span class="codeph"> PTTimedMetadata </span> -Instanz darauf vorbereitet ist. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Die folgenden Codefragmente veranschaulichen einige Möglichkeiten zur Verwendung von Benachrichtigungen.
...
Satz `subtitlesOptions` und `audioOptions`:
