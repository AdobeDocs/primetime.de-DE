...
* `AuditudeResolver` for `AUDITUDE_METADATA_KEY`, das mit Adobe Primetime-Werbeanzeigen-Entscheidungsservern (früher Auditude genannt) kommunizieren kann und Werbeunterbrechungen zurückgibt, die platziert werden sollen.
