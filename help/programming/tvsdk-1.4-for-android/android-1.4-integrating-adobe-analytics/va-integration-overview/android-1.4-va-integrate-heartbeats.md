...
<table id="table_3565328ABBEE4605A92EAE1ADE5D6F84"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Wichtig: Der Name dieser JSON-Konfigurationsdatei muss beibehalten werden. <span class="codeph"> ADBMobileConfig.json </span>. Der Name und der Pfad dieser Konfigurationsdatei können nicht geändert werden. Der Pfad zu dieser Datei muss <span class="codeph"> &lt;source root=""&gt;/assets </span>. </p> </td> 
  </tr> 
  <tr> 
