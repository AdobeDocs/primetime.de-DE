...
1. Aufruf `event.getLoadInformation()` zum Lesen der relevanten Daten aus dem `event` Parameter, der an den Rückruf übergeben wird.
   ...
   >[!NOTE]
   >
   >Weitere Informationen `LoadInformation`finden Sie unter [2.7 für Android-(Java)](https://help.adobe.com/en_US/primetime/api/psdk/javadoc_2.7/index.html) API-Dokumente.
