...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse, die Track erweitert, um die Abstraktion des Audiospur zu definieren.</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse, die Track erweitert, um die Abstraktion von Untertiteln zu definieren. Eine geschlossene Untertitelspur wird eindeutig durch ihren Namen UND ihren Diensttyp definiert. Verschiedene Diensttypen können denselben Namen haben.</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse, die die standardmäßigen Typen von Untertiteln enthält. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse, die die standardmäßigen Wiedergaberaten enthält. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse, die die Abstraktion von DRM-Metadaten definiert. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="0"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/info/Track.html" format="html" scope="external"> Verfolgen</a></span></td> 
