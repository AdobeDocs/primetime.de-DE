...
Eine *`ad break`* enthält eine oder mehrere Anzeigen, die nacheinander abgespielt werden. Browser TVSDK fügt Anzeigen in den Hauptinhalt als Mitglieder einer oder mehrerer Werbeunterbrechungen ein.
