...
seo-description: Es gibt einige APIs, die Ihnen bei der Verwendung des Adobe Flash Players helfen können.
seo-title: Hilfreiche APIs für Adobe Flash Player
title: Hilfreiche APIs für Adobe Flash Player
...
# Hilfreiche APIs für Adobe Flash Player{#helpful-apis-for-the-adobe-flash-player}
...
Falls unterstützt, können Sie den `forceFlash` Parameter verwenden, um die Wiedergabetechnologiebestimmungssequenz zu überschreiben und die Implementierung zur Verwendung des Flash Players zu zwingen.
