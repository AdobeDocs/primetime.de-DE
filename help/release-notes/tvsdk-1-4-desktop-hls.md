...
* Zendesk #27460 - Das neue Akamai-Konto kann eine POST-CDN-Anfrage nicht verarbeiten.
  ...
  Das neue CDN-Konto kann eine POST-CDN-Anfrage nicht verarbeiten. Dieses Problem wurde behoben, indem der Code so aktualisiert wurde, dass die cdn.auditude.com -Anzeigenanforderung anstelle der POST als GET angezeigt wird.
...
* Zendesk #28218 - Tracking-Ereignis wird nicht ausgelöst, während der Absturz vom Fortsetzungspunkt
  ...
  Dieses Problem ist dasselbe Problem wie in Zendesk #26592. Das Problem, bei dem Suchvorgänge zulässig waren, wenn sich der Medienplayer im Status VORBEREITT für VOD-Streams befindet, wurde behoben.
...
**Hinweis**: Dieses Problem erfordert Flash Player 23.0.0.185 oder höher.
...
Wichtig: Dieses Problem erfordert Flash Player 23.0.0.185 oder höher.
...
Dieses Problem wurde behoben, indem der Code hinzugefügt wurde, um den AUDITUDE_METADATA_KEY zu überprüfen, und indem die AUDITUDE_METADATA_KEY und ADVERTISING_METADATA_KEY austauschbar gemacht wurden.
...
Nach dem Erhalt eines 404-Fehlers bei bestimmten Anfragen kann es zu einem Absturz kommen. Dieses Problem wurde behoben, indem sichergestellt wurde, dass die Verbindung nicht heruntergefahren wird, während die Antwort verarbeitet wird. Die Lösung stellt sicher, dass die VPAID-Anzeigendateien nicht falsch gezählt werden, sodass sie beim Herunterladen nicht veröffentlicht werden.

* Zendesk #23621 - Retry schlägt in 400 und 404 fehl

**Hinweis**: Dieses Problem erfordert Flash Player 23 oder höher.

Fehlerkorrektur - Beim Wechseln zwischen verschiedenen Profilen treten jetzt keine DRM-Metadaten mehr auf.
...
* Zendesk #22110 - Analytics: Add a h:sc:ssl -Feld zu den Heartbeat-Tracking-Aufrufen
...
* Zendesk #22608 - Video zeigt gelegentlich einen schwarzen Bildschirm (Flash Player 22.0.0.175 oder höher erforderlich)
...
Die Auditude-Anfrage analysiert die AuditudeSettings für benutzerdefinierte Parameter beim Erstellen einer Werbeeinheit für Werbeanfragen.
...
**Hinweis**: Dieses Problem erfordert Flash Player 21.0.0.211 oder höher.
...
**Hinweis**: Dieses Problem erfordert Flash Player 20.0.0.306 oder höher.

* Zendesk #19286 - Flash Player ist beim Suchen in einem FER-Stream aufgetreten.
...
* Zendesk # 19359 - Flash Player ist aufgrund der Position von #EXT-X-FAXS-CM: Attribut im Manifest auf Setebene abgestürzt.
...
* Zendesk #18554 - Stream Integrity trimmen die Cookies in einigen Fällen
...
**Hinweis**: Für die Auflösung ist Flash Player FP 19.0.0.207 oder höher erforderlich.

Dieses Problem ist mit Zendesk #3732 identisch.

* Zendesk #17907 - Lag auf pHLS Live Stream mit Flash Player 19
...
* Zendesk #17973 - Neueste Flash Player 19.0.0.185 stürzt während des Mid-Roll ab
...
* Zendesk #4377: AD_BREAK_SKIPPED-Ereignis beim Überspringen einer Werbeunterbrechung aufgrund der Anzeigenrichtlinie auslösen
...
* Zendesk #4037 - Kein nutzbarer Profilfehler (Flash Player 18.0.0.232 oder höher erforderlich)

URL-Parsing-Problem beheben, wenn der Abfrageparameter &quot;http&quot;enthält

* Zendesk #4260 - Flash Player 18 stürzt in IE11 ab (erfordert Flash Player 18.0.0.232 oder höher)
...
* Zendesk #4306 - Flash Player-Absturz nur bei Vollbild unter Windows (erfordert Flash Player 18.0.0.232 oder höher)
...
* Zendesk #3113 - Flash Player Plugin Crashing (erfordert Flash Player 18.0.0.200)
* Zendesk #3268 - Desktop: Videoplayer flackert nach +- 40/50 Sekunden und wird nach +- 90 Sekunden schwarz (Flash Player 18.0.0.200 erforderlich)

Behebung eines Bühnenfehlers bei Videos.
...
* Zendesk #3905 - TVSDK-Player wird beim Hosten auf CDN nicht geladen
...
* Zendesk #3601 - Enhancement request: Wrapper Companion Management
   ...
   * Wrapperbegleiter mit Ressource werden ignoriert, es sei denn, sie werden für die Anzeige verwendet. (wird nicht für Tracking verwendet)
...
* Zendesk #2652 - Auditude-Dokumentation für Desktop-HLS, Klarere Auditude-Medien-ID für Desktop-HLS-Dokumentation

**Version 1.4.5**

* Zendesk #2256 - Zugriff auf Master-Playlist, aktualisiertes PSDK zum Senden von timedMetadata-Ereignissen für abonnierte Tags auf der Master-Playlist. (Flash Player-Version 17.0.0.134 erforderlich)
* Zendesk #2417 - Player versucht, Untertitel vor dem Wiedergabebeginn herunterzuladen, verwendet WebVTT die falsche Segmentnummernvariable für die Segmentnummerübereinstimmung. Fehler wurden nur für Medien angezeigt, bei denen Segmentindizes bei null lagen. (Flash Player-Version 17.0.0.134 erforderlich)
...
* Zendesk #2547 - Arabische Untertitel: Text sollte rechtsbündig ausgerichtet werden (Flash Player-Version 17.0.0.134 erforderlich)

**Version 1.4.4**

* Zendesk #1561 - Re: `[Adobe Primetime]` Aktualisierung: HLS-Client-basierte Failover-Unterstützung für PROGRAM-DATE-TIME im Desktop PSDK (Flash Player-Version 16.0.0.305 oder höher erforderlich)
* Zendesk #2197 - `[Ads]` Tracking von Anzeigenfehlern
* Zendesk #2286 - Feature Request: Geben Sie Informationen zum Anzeigenladestatus (VPAID) an
* Zendesk #2285 - Feature Request: Skip ad after a specified timeout duration
* Fehler #3921755 - Aktualisierung der OpenSSL-Bibliothek auf Flash Player auf Version 1.0.1L (Flash Player-Version 16.0.0.305 oder höher erforderlich)

**Version 1.4.2**

* Zendesk #1303 - Vertical Offset for Closed Caption (Flash Player-Version 16.0.0.235 oder höher, erwartetes Veröffentlichungsdatum: Dezember 2014)
* Zendesk #1870 - Closed Caption Turning On and Off (Flash Player-Version 16.0.0.235 oder höher, erwartetes Veröffentlichungsdatum: Dezember 2014)
...
* **Version 1.4.0**
   ...
   * Fehler #3753725 - selectPolicyForSeekIntoAd berücksichtigt nicht, ob die Werbeunterbrechung gesehen wurde
