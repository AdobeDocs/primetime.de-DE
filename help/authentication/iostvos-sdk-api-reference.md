...
* *requestorID*: Die eindeutige ID, die mit dem Programmierer verknüpft ist. Übergeben Sie die von Adobe zugewiesene eindeutige ID an Ihre Site, wenn Sie sich zum ersten Mal beim Primetime-Authentifizierungsdienst registrieren.
...
* *description*: Zusätzliche Details zum Fehlerszenario. Wenn diese beschreibende Zeichenfolge aus keinem Grund verfügbar ist, sendet die Primetime-Authentifizierung eine leere Zeichenfolge **(&quot;&quot;)**.\
