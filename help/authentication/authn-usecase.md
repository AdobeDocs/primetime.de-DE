...
>[!NOTE]
>
>Die AuthN-Anfrage, die ein MVPD mit Adobe Primetime-Authentifizierung erhält, enthält keine digitale Signatur. Im folgenden Beispiel wird jedoch aus Gründen der Kürze keine Signatur angezeigt. Ein Beispiel für eine digitale Signatur finden Sie im Beispiel unter [Authentifizierungsantwort](#authn-response) in den folgenden Abschnitten.
